...
export default function Amalgame({updateRupeeBalance}) {
  const [selectedItemId, setSelectedItemId] = useState('');
  const [selectedItemId2, setSelectedItemId2] = useState('');
  const [fusedItem, setFusedItem] = useState('');
  const [fuseButton, setFuseButton] = useState(true);
      ...
      <Grid container spacing={0}>
        ...
        <Grid item xs={4}>
          ...
          <AmalgameFilter
            ...
            onOptionChange2={handleOptionChange2}
          />
        </Grid>
      </Grid>
